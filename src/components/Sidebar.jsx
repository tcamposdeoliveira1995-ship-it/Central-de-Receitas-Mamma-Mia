...
import { LayoutGrid, Beef, BookOpen, Calculator, Percent, Factory, Flame, Snowflake, Menu, X, Users, Workflow, Package, Network } from "lucide-react";
import { isDemoMode } from "@/lib/sheetsClient";

const links = [
  { href: "/", label: "Dashboard", icon: LayoutGrid },
  { href: "/materias-primas", label: "Matérias-Primas", icon: Beef },
  { href: "/setores", label: "Setores", icon: Workflow },
